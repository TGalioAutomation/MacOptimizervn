    ...
    var body: some View {
        HStack(spacing: 60) {
            ...
            VStack(alignment: .leading, spacing: 30) {
                // Tiêu đề thương hiệu (kiểu thống nhất)
                ...
                // Hàng tính năng (kiểu thống nhất)
                ...
                Button(action: { selectFiles() }) {
                    Text(loc.L("select_files"))
                        ...
                        .padding(.vertical, 8)
                        .background(Color(hex: "4DDEE8")) // Teal - Hợp nhất với Thùng rác
                        .cornerRadius(6)
                }
                .buttonStyle(.plain)
                .padding(.top, 10)
            ...
            // Biểu tượng bên phải (kích thước và bóng đồng đều)
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                // Nút trợ lý đã bị xóa (hợp nhất với Quét thông minh)
                    ...
                    ForEach(service.items) { item in
                        HStack {
                            Image(systemName: "checkmark.circle.fill")
                                .foregroundColor(Color(hex: "4DDEE8")) // màu đồng nhất
